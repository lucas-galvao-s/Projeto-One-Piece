...
const bottons = document.querySelectorAll('.botao');

const character = document.querySelectorAll(".character");

bottons.forEach((botao, indice) => {
    botao.addEventListener("click", () => {
        ...
        character[indice].classList.add("select");
    })
})
function desselecionarPersonagem() {
    const personagemSelecionado = document.querySelector(".character.select");
